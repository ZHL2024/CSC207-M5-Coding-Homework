...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        boolean hasLower = Pattern.compile(".*[a-z].*").matcher(str).matches();
        boolean hasUpper = Pattern.compile(".*[A-Z].*").matcher(str).matches();
        boolean hasDigit = Pattern.compile(".*\\d.*").matcher(str).matches();
    ...
    public static List<String> extractEmails(String str) {
        ...
        final Pattern pattern = Pattern.compile("\\S*\\w@(mail\\.)?utoronto\\.ca");
